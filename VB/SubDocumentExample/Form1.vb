...
'            #End Region ' #DDD
        ...
        Private Sub btnChangeText_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnChangeText.Click
'            #Region "#EEE"
            Dim par As Paragraph = richEditControl1.Document.Paragraphs(0)
